...
import com.avisys.email.service.MailService;
...
public class MailController {
	...
	public ResponseEntity<MailNotification> softDelete(@PathVariable Long id, @PathVariable String updatedBy) throws CloneNotSupportedException {
