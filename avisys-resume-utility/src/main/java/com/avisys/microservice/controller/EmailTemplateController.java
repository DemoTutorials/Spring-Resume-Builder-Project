...
import com.avisys.microservice.exception.EmailTemplateNotFoundException;
...
public class EmailTemplateController {
	...
	@CrossOrigin(origins = "*", allowedHeaders = "*")
	@JsonView(Views.EmailTemplate.class)
	public ResponseEntity deleteContact(@PathVariable Long id, @PathVariable String updatedBy) {
